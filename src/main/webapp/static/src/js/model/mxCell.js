 ...
 * Function: setTypeId
 *
 * Sets the typeId of the cell to the given string.
 */
mxCell.prototype.setTypeId = function(typeId)
{
	this.typeId = typeId;
};

mxCell.prototype.getTypeId = function()
{
    return this.typeId;
};
