...
EditorUi.prototype.showPreview=function(){
    mxUtils.show(this.editor.graph, null, 10, 10);
};


EditorUi.prototype.saveToImage = function()
{
    var graph = this.editor.graph;
    ...
    if (w > 0 && h > 0)
    {
        ...
        var format = 'png';
        var bg = '&bg=#FFFFFF';
        var req = new mxXmlRequest(SAVEIMAGE_URL, 'filename=' + name + '&format=' + format +
            bg + '&w=' + w + '&h=' + h + '&xml=' + xml).simulate(document, '_blank');
