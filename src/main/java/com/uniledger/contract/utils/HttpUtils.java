...
public class HttpUtils {
     ...
     */
    public byte[] post(String url, Object data, String token, String contentType, String charset) throws Exception {
...
//            throw new Exception("data type must in String or byte[]");
            if (contentType == null || "".equals(contentType)) {
                contentType = "application/x-protobuf"; // protobuf transfer
            }
            httpPost.setHeader("Content-type", contentType);
...
//                return EntityUtils.toByteArray(entityResponse);
    ...
    public String postXml(String url, String xmlStr, String token) throws Exception {
        ...
        byte[] respBuffer = post(url, reqBuffer, token,"application/xml; charset=UTF-8", null);
