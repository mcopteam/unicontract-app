        ...
        for (int i = 0; i < 500; i++)
        {
           ...
           // System.out.println("bb : " + bb);
            if (!doCheck || (doCheck && !bb))
            {
                ...
                String Base58PK = Base58Codec.doEncode(pk);
                String Base58SK = Base58Codec.doEncode(sk);
                byte[] Base58SK_32_byte =  Arrays.copyOf(sk,32);
                String Base58SK_32 = Base58Codec.doEncode(Base58SK_32_byte);

                System.out.println("Base58PK = " + Base58PK);
                System.out.println("Base58SK = " + Base58SK);
                System.out.println("Base58SK_32 = " + Base58SK_32);
