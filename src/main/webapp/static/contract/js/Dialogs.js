...
var EditDataDialog = function(ui, cell)
{
	...
	if (!mxUtils.isNode(value))
	{
		...
		obj.setAttribute('label', value || '');
		 switch (value){
		 	case '决策':
		 		obj.setAttribute('Caption', '决策' || '');
		 		obj.setAttribute('Ctype', '决策' || '');
		 		break;
		 	case '查询':
		 		obj.setAttribute('Ctype', '查询' || '');
		 		obj.setAttribute('Caption', '查询' || '');
		 		break;
		 	case '动作':
		 		obj.setAttribute('Ctype', '动作' || '');
		 		obj.setAttribute('Caption', '动作' || '');
		 		break;
		 	case '计划':
		 		obj.setAttribute('Ctype', '计划' || '');
		 		obj.setAttribute('Caption', '计划' || '');
		 		break;
		 	default:
		 		break;
		 }
		// obj.setAttribute('Cname', '' || '');
		// obj.setAttribute('Creator', ''|| '');
		value = obj;
	}
	...
	applyproperty();
	var applyBtn = mxUtils.button(mxResources.get('apply'), applyproperty);
	applyBtn.className = 'geBtn gePrimaryBtn';
