...
mxGraph.prototype.addCnameArray = function (value) {
    for(var i=0;i<this.cnameArray.length;i++){
        if(this.cnameArray[i]==value){
            return
        }
    }
    this.cnameArray.push(value)
};
mxGraph.prototype.getCnameArray = function () {
    return this.cnameArray
};
